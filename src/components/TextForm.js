...
export default function TextForm(props) {
    ...
    <div className="container my-3" style={{color: props.mode==='light'?'black':'white'}}>
      ...
      <p>Reading {text.split(/\s+/).filter((el)=>{return el.length!==0}).length} words will take you <strong>{0.008 * text.split(" ").filter((el)=>{return el.length!==0}).length} minutes</strong> to read!</p>
      <h2>Preview</h2>
